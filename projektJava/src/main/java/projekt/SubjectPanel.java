...
/**
 * Panel odpowiedzialny za zarządzanie przedmiotami w aplikacji. Umożliwia
 * dodawanie nowych przedmiotów, edycję kryteriów oceniania oraz usuwanie
 * przedmiotów. Przedmioty są wyświetlane w tabeli wraz z przypisanymi
 * kryteriami.
 * 
 * @author Natalia Rzeszótko, Damian Jokisz
 * 
 */
public class SubjectPanel extends JPanel {
	...
	/**
	 * Otwiera okno dialogowe umożliwiające dodanie nowego przedmiotu. Po
	 * zatwierdzeniu dodaje go do bazy danych i odświeża tabelę.
	 */
	...
	/**
	 * Umożliwia edycję kryteriów oceniania wybranego przedmiotu. Pozwala dodawać i
	 * usuwać kryteria oraz ustalać maksymalne punkty.
	 */
	private void editCriteria() {
		...
		JDialog dialog = new JDialog(SwingUtilities.getWindowAncestor(this), "Edytuj Kryteria",
		...
		addCriterion.addActionListener(ae -> {
			...
			Object[] inputs = { "Nazwa kryterium:", nameField, "Maks. punkty:", maxPointsField };
			...
			if (result == JOptionPane.OK_OPTION) {
				try {
					...
					JOptionPane.showMessageDialog(dialog, "Nieprawidłowa liczba punktów!", "Błąd",
