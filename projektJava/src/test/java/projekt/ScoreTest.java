...
/**
 * Klasa testowa dla {@link Score}.
 * Testuje metodę {@link Score#toString()} dla różnych przypadków danych.
 *
 * @see Score
 * @see Student
 * @see Subject
...
class ScoreTest {
     ...
     * Tworzy obiekt {@link Student}, {@link Subject} oraz {@link Score}.
     *
    ...
    /**
     * Testuje metodę {@link Score#toString()} dla innego zestawu danych.
     * Sprawdza, czy metoda poprawnie generuje reprezentację tekstową.
     *
     * @see Score#toString()
     */
    @Test
