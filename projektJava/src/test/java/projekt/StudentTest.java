...
/**
 * Klasa testowa jednostkowa dla klasy {@link Student}.
 * Testuje poprawność tworzenia obiektów, przypisywania punktów i obsługi wyjątków.
 */
class StudentTest {
    ...
    /**
     * Inicjalizuje dane testowe przed każdym testem.
     * Tworzy przykładowego studenta, grupę i przedmiot z kryterium oceniania.
     */
    @BeforeEach
    void setUp() {
    ...
    /**
     * Test metody {@link Student#addPoints(Subject, String, int)} w przypadku poprawnych danych.
     *
     * @throws RegisterException jeśli wystąpi błąd przypisania punktów (nie powinien wystąpić tutaj)
     */
    @Test
    ...
    /**
     * Test metody fabrycznej {@link Student#createStudent(String, String, String, Group)},
     * która tworzy nowy obiekt studenta.
     */
    @Test
    ...
    /**
     * Test sprawdzający, czy metoda {@link Student#getGrades()} poprawnie zwraca mapę ocen.
     *
