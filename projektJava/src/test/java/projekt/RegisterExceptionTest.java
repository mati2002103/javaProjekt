...
/**
 * Klasa testowa sprawdzająca działanie klasy {@link RegisterException}.
 * Testuje konstruktory oraz rzucanie wyjątków.
 *
...
class RegisterExceptionTest {
    ...
    /**
     * Testuje konstruktor {@link RegisterException#RegisterException(String, Throwable)}.
     * Sprawdza, czy komunikat oraz przyczyna wyjątku są poprawnie przypisane.
     *
     * @see RegisterException#getMessage()
    ...
    /**
     * Testuje rzucanie wyjątku {@link RegisterException} z komunikatem.
     * Sprawdza, czy wyjątek jest poprawnie zgłaszany przez metodę.
     *
