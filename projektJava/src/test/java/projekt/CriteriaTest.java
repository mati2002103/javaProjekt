...
/**
 * Klasa testowa sprawdzająca poprawność działania klasy Criteria. Testuje
 * konstruktor, metody dostępowe (gettery/settery), toString, equals i hashCode.
 * 
...
public class CriteriaTest {
	...
	public void testConstructorAndGetters() {
		// Tworzenie obiektu i sprawdzenie, czy gettery zwracają wartości ustawione
		// przez konstruktor
	...
	/**
	 * Testuje metodę setMaxPoints — sprawdza czy maksymalna liczba punktów została
	 * poprawnie zmieniona.
	 *
	 * @return brak zwracanej wartości — testuje aktualizację maksymalnej liczby
	 *         punktów.
	 */
	@Test
	...
	/**
	 * Testuje metodę equals — porównanie dwóch obiektów o tej samej nazwie (różne
	 * wielkości liter).
	 *
	...
	/**
	 * Testuje metodę equals — ten sam obiekt porównywany do siebie powinien być
	 * równy.
	 *
	...
	/**
	 * Testuje metodę equals — porównanie z obiektem innej klasy powinno zwrócić
	 * false.
	 *
	...
	/**
	 * Testuje zgodność metod equals i hashCode — te same nazwy (niezależnie od
	 * wielkości liter) powinny mieć ten sam hashCode.
	 *
	...
	public void testHashCodeConsistentWithEquals() {
		...
		assertEquals(c1.hashCode(), c2.hashCode(),
				"hashCode powinien być taki sam dla równych obiektów (case-insensitive)");
	}
	...
	/**
	 * Testuje kombinację setName i setMaxPoints — oba atrybuty powinny być
	 * poprawnie zmienione.
	 *
