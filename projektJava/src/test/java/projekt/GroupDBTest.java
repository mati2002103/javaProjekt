...
class GroupDBTest {
	...
	/**
	 * Inicjalizuje obiekty testowe przed każdym testem: tworzy bazę grup, grupę
	 * oraz przypisanego do niej studenta.
	 */
	@BeforeEach
	void setUp() {
		groupDB = new GroupDB();
	...
	void testUpdateGroup() {
		...
		boolean updated = groupDB.updateGroup("ID05TC01", "Technologie webowe",
				"Grupa dla studentów zajmujących się technologiami webowymi");
