...
/**
 * Klasa reprezentująca panel do zarządzania grupami.
 * Pozwala dodawać, edytować, usuwać oraz importować/eksportować grupy.
 */
    ...
    private void importGroups() {
        ...
        if (option == JFileChooser.APPROVE_OPTION) {
            try (DataInputStream in = new DataInputStream(new FileInputStream(chooser.getSelectedFile()))) {
                ...
                JOptionPane.showMessageDialog(this, "Błąd podczas importu: " + e.getMessage(), "Błąd", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    private void exportGroups() {
        ...
        if (option == JFileChooser.APPROVE_OPTION) {
            try (DataOutputStream out = new DataOutputStream(new FileOutputStream(chooser.getSelectedFile()))) {
                ...
                JOptionPane.showMessageDialog(this, "Błąd podczas eksportu: " + e.getMessage(), "Błąd", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
}
